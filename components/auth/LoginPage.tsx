    ...
    <div className="flex flex-col h-full bg-app-bg relative font-active overflow-hidden min-h-screen" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      <div className="flex-1 overflow-y-auto no-scrollbar px-6 pt-12 pb-10 flex flex-col justify-center">
        ...
        <button
          onClick={handleLogin}
          disabled={loading}
          className="w-full bg-app-gold text-white font-semibold py-4 rounded-2xl shadow-lg shadow-app-gold/30 active:scale-95 transition-transform mb-4 disabled:opacity-60 disabled:active:scale-100"
        >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1 text-sm font-medium active:opacity-70"
        >
          <span className="text-app-textSec">{t.noAccountPrefix}</span>
