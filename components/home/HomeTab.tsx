...
export default function HomeTab({ onBook, favourites, onToggleFavourite }: Props) {
    ...
    return (
        <div className="flex flex-col items-center h-[100vh] bg-app-bg relative font-arefRuqaa overflow-hidden">
            <HomeDrawer
                open={isMenuOpen}
            ...
            <AppHeader
                ...
                title={
                    <div className="flex items-center justify-center gap-2 px-2 cursor-pointer w-full" onClick={() => navigate("/")}>
                        ...
                        <span className="text-lg font-semibold text-app-text font-arefRuqaa truncate">ميزو دو نور</span>
                    </div>
                }
                actionEnd={
                    <button
