                ...
                <div className="flex-1 overflow-y-auto no-scrollbar py-4 flex flex-col">
                    ...
                    <div className="px-6 mt-6 space-y-3">
                        ...
                        {/android/i.test(navigator.userAgent) ? (
                            <button
                                onClick={() => {
                                    // Using _system helps Cordova/Capacitor webviews open the external device browser
                                    window.open("https://play.google.com/store/apps/details?id=com.Raiyansoft.TrandyHair", "_system") || 
                                    window.open("https://play.google.com/store/apps/details?id=com.Raiyansoft.TrandyHair", "_blank");
                                    onClose();
                                }}
                                className="w-full py-3.5 rounded-xl border border-app-gold px-2 text-app-gold font-semibold text-sm flex items-center justify-center gap-2 active:scale-95 transition-transform"
                            >
