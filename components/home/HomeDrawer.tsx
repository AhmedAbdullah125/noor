                            ...
                            <button
                                onClick={() => {
                                    ...
                                    window.location.href =
                                        "intent://play.google.com/store/apps/details?id=com.Raiyansoft.TrandyHair" +
                                        "#Intent;scheme=https;package=com.android.chrome;" +
                                        "S.browser_fallback_url=https%3A%2F%2Fplay.google.com%2Fstore%2Fapps%2Fdetails%3Fid%3Dcom.Raiyansoft.TrandyHair;end";
                                }}
                                className="w-full py-3.5 rounded-xl border border-app-gold px-2 text-app-gold font-semibold text-sm flex items-center justify-center gap-2 active:scale-95 transition-transform"
                            >
                                <ShoppingBag size={18} />
