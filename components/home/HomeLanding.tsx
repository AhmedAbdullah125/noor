            ...
            <div className="px-6 mb-6" ref={wrapperRef}>
                <div className="relative w-full">
                    <input
                        ...
                        className="w-full bg-white border border-app-card  rounded-full py-2 pr-10 pl-8 text-right focus:outline-none focus:border-app-gold shadow-sm font-arefRuqaa text-xs"
                    />
