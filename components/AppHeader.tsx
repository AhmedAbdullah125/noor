...
const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center justify-between px-6 pt-6 pb-4 max-w-[430px] m-auto shadow-sm border-b border-app-card/30 transition-all ${bgClassName} ${className}`}>
