...
const TabBar: React.FC<TabBarProps> = ({ currentTab, onTabChange }) => {
  ...
  return (
    <div className="fixed max-w-[420px] w-[90%] border-2 border-app-card bottom-1 rounded-3xl left-1/2 -translate-x-1/2 w-full bg-app-bg border-t border-app-card shadow-[0_-4px_12px_rgba(0,0,0,0.03)] z-50">
